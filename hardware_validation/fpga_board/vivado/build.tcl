...
set fpga_board_root [file normalize [file join $script_dir ".."]]
set project_root [file normalize [file join $fpga_board_root ".." ".."]]
...
read_xdc [file join $script_dir "constraints_fpga_board.xdc"]
