...
local hardware-validation rows remain available for reference, while board-level
...
\item \texttt{hardware\_validation/}: FPGA board-oriented xsim/Vivado validation flow.
...
The hardware side contains RTL blocks and a FPGA board-centered validation flow. The
...
validation scripts are present, but fresh Vivado hardware execution and FPGA board
...
\item Collect physical board measurements.
...
fresh Vivado runs, board measurements, and estimator calibration.
