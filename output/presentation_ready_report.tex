...
execution was skipped in the latest smoke run. Board measurement is the
main pending step.
\end{minipage}}
\end{center}
...
\texttt{hardware\_validation/} & xsim and Vivado flow for FPGA board-oriented validation \\
...
\item physical board measurements.
\end{itemize}
...
FPGA board-oriented validation scripts are in the repo, but fresh Vivado execution
and physical board measurements are the remaining hardware tasks.''
\end{quote}
...
\item Boot FPGA board and collect physical board measurements.
